...
import { motion } from 'framer-motion';
import {
  Leaf, Sun, Mail, Lock, User, Wind, Droplets, ArrowRight,
  Battery, Zap, TreePine, Eye, EyeOff
} from 'lucide-react';
          ...
          <div className="bg-white/90 rounded-3xl p-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white py-2 sm:py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center space-x-2 disabled:opacity-70 mt-4 text-sm sm:text-base"
              >
                {isLoading ? (
