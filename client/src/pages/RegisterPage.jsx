  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="bg-white/90 rounded-3xl p-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white py-2 sm:py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center space-x-2 disabled:opacity-70 mt-4"
              >
                {isLoading ? (
      ...
      <div className="hidden md:block md:w-1/2 relative bg-gradient-to-br from-green-600 to-emerald-700 overflow-hidden">
        {/* Éléments décoratifs (identique au Login) */}
